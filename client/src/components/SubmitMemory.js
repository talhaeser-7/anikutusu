...
const SubmitMemory = () => {
    ...
    return (
        <>
            <Form onSubmit = {(e) =>{
                e.preventDefault() //sayfanın kendini yenilememesi için
                ...
                <Form.Group>
                    ...
                    <Form.Control name='author' type='text' onChange={(e) => setMemoryData({...memoryData,creator:e.target.value})}></Form.Control>
                </Form.Group>
                ...
                <main className='py-1'>
                    <Button type='submit' block>Gönder</Button>
                </main>
            </Form>
